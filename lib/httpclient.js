...
var BinaryPart = function(data, filename) {
    ...
    this.write = function(name, writer, outStream) {
        ...
        writer.append("Content-Disposition: form-data; name=\"")
                ...
                .append(filename || name).append("\"").append(CRLF);
    ...
    Object.defineProperties(this, {
        ...
        "contentBytes": {
            "get": function() {
                ...
                try {
                    var bos = new ByteArrayOutputStream(8192);
                    this.contentStream.copy(bos);
                    return responseContentBytes = new ByteArray(bos.toByteArray());
                } finally {
